...
<body>
	<header>
		<div class="header_bar">
			...
			<div class="recherche">
				<form action="recherche.php" class="form_recherche" method="GET">
					<div class="recherche_bar_loupe">
						<!--<div class="div_loupe">-->
							
							<button class="button_loupe" type="submit"><img type="image" class="loupe" src="../Logo/loupe.png" alt="loupe"></button>
							<input class="search_bar" type="text" name="recherche">
						<!--</div>-->
					</div>
				</form>
			</div>
