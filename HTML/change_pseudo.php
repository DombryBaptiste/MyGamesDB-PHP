...
<body>
	...
	<div class="account">
		<p class="p_account"><span class="span_account">Choisir un nouveau pseudo</span></p>
		<p class="p_pseudo">
			<form method="GET" action="../PHP/change_pseudo_user.php" class="form_new_pseudo">
				<input  class="new_pseudo_input" type="text" name="new_pseudo">
				<input class="new_pseudo_input" type="submit" value ="Modifier" name="Modifier">
			</form>
		<p>
	</div>
</body>
